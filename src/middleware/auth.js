...
const PERMISSIONS = {
  ...
  MANAGER: [
    ...
    'hr.*', 'payroll.view', 'payroll.manage', 'invoices.*', 'documents.*', 'content.*', 'sgsst.*', 'inventory.*', 'pos.*', 'revenue.*', 'channels.*',
  ],
  FRONTDESK: [
  ...
  ACCOUNTING: [
    ...
    'approvals.view', 'notifications.*', 'invoices.*', 'payroll.view', 'hr.view', 'documents.view', 'inventory.view',
  ],

...
const PERMISSIONS = {
  ...
  MANAGER: [
    ...
    'hr.*', 'payroll.view', 'payroll.manage', 'invoices.*', 'documents.*', 'content.*', 'sgsst.*', 'inventory.*', 'pos.*', 'revenue.*',
  ],
  FRONTDESK: [
  ...
  SALES: [
    ...
    'payments.link', 'guests.*', 'notifications.*', 'whatsapp.view', 'content.*', 'revenue.view',
  ],
